    ...
    <SectionCard title="Liên kết và Nút mô tả" id={id}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
        <div>
          ...
          <p className="mb-2">
            Để biết thêm thông tin, <a href="#" className="text-indigo-600 underline hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">bấm vào đây</a>.
          </p>
        ...
        <div>
          ...
          <p className="mb-2">
            Đọc thêm về <a href="#" className="text-indigo-600 underline hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">chính sách tiếp cận của chúng tôi</a>.
          </p>
